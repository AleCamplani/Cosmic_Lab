...
two signals. We use a fix signal from the GPS to monitor if we have a fix, 
...
The FIX signal must enter at pin D5
...
ISR(PORTB_PORT_vect){ // called by Change in FIX
  PORTB.INTFLAGS = 4;//clear Flag //Pin PB2 = D5
}
