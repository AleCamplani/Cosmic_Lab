...
plt.close('all')
filename='..\Datafiles\Coicidence1Run6.txt' #File currently being written to
...
timeout=600#Number of seconds to liveplot for at max
...
while((time.time()-Start)<timeout):
    ...
    plt.figure(1)
    plt.hist(time_deltas,bins=100,range=(0,np.max(time_deltas)),color="red")
    plt.pause(0.05)
