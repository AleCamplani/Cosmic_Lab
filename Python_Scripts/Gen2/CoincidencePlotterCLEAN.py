...
times=times-times[0]#subtract starting time
...
mu_guess=np.mean(len(Data)/times[-1]*timeBin)
...
plt.savefig('CoincidenceHistogram.png', dpi=600)
...
plt.savefig('CoincidenceBinnedRate.png', dpi=600)
